      ...
      <AnimatedBackground>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <AnimatedSection delay={400} className="mt-12 relative">
              <div className="max-w-4xl mx-auto">
                <div className="relative rounded-xl bg-white shadow-xl overflow-hidden border border-zinc-200 floating">
                  ...
                  <div className="p-4">
                    <div className="bg-blue-50 border-l-4 border-blue-300 rounded p-3 mb-4">
                      <div className="text-xs text-zinc-500 mb-1">Interviewer • 2:34 PM</div>
                    ...
                    <div className="bg-green-50 border-l-4 border-green-300 rounded p-3">
                      <div className="text-xs text-zinc-500 mb-1">AI Assistant • 2:34 PM</div>
                ...
                {/* Decorative elements */}
                <div className="absolute -top-6 -right-6 w-64 h-64 bg-accent-400/10 rounded-full mix-blend-multiply filter blur-xl"></div>
                <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-primary-400/10 rounded-full mix-blend-multiply filter blur-xl"></div>
              </div>
            </AnimatedSection>
          </div>
        </section>
              ...
              {testimonials.map((testimonial, index) => (
                <AnimatedSection key={index} delay={index * 150}>
                  <AnimatedCard className="h-full p-6 relative">
                    ...
                    <p className="text-zinc-600 mb-4 relative z-10">{testimonial.quote}</p>
        ...
        <footer className="bg-zinc-900 text-white py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h1 className="text-2xl font-bold text-gradient mb-4">InterviewAssist</h1>
              <p className="text-zinc-400">Your AI-powered interview coach that helps you prepare and excel in job interviews.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
              <ul className="space-y-2">
                <li><Link to="/" className="text-zinc-400 hover:text-white transition-colors">Home</Link></li>
                <li><Link to="/interview" className="text-zinc-400 hover:text-white transition-colors">Interview Room</Link></li>
                <li><Link to="/profile" className="text-zinc-400 hover:text-white transition-colors">Profile</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Contact Us</h3>
              <p className="text-zinc-400">Questions or feedback? Reach out to our team.</p>
              <div className="mt-4">
