        ...
        <div className="bg-gray-900/50 rounded-lg p-6 border border-gray-800">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 bg-gray-800/50 rounded p-4 border border-gray-700">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm text-gray-400">Activate AI:</span>
                    <span className="inline-block bg-gray-700 text-gray-300 px-2 py-0.5 rounded text-xs font-mono">Space</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-400">Hide Overlay:</span>
                    <span className="inline-block bg-gray-700 text-gray-300 px-2 py-0.5 rounded text-xs font-mono">Esc</span>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm text-gray-400">Next Suggestion:</span>
                    <span className="inline-block bg-gray-700 text-gray-300 px-2 py-0.5 rounded text-xs font-mono">Tab</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-400">Use Suggestion:</span>
                    <span className="inline-block bg-gray-700 text-gray-300 px-2 py-0.5 rounded text-xs font-mono">Enter</span>
                  </div>
                </div>
              </div>
            </div>
